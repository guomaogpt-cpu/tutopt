...
export const VERTICAL_FORM_CONFIG: Record<ListingVertical, VerticalFormConfig> = {
  OPT: {
    ...
    descriptionSectionDescription:
      "Опишите товар, условия поставки, наличие и минимальную партию.",
  ...
  CARGO: {
    titleLabel: "Название карго-компании или услуги",
    titlePlaceholder: "Например: Карго Бишкек — Гуанчжоу",
    titleHint: "Укажите название компании или тип карго-услуги",
    basicsDescription: "Название поможет клиентам найти вашу карго-компанию.",
    categoryDescription: "Выберите тип карго-услуги.",
    priceSectionTitle: "Стоимость услуги",
    priceSectionDescription: "Укажите стоимость, если она известна.",
    priceLabel: "Стоимость услуги, если есть",
    priceHint: "Можно указать ориентировочную стоимость",
    showMoq: false,
    ...
    defaultUnit: ListingUnit.PIECE,
    locationSectionTitle: "Город / офис",
    locationSectionDescription: "Укажите город или офис компании.",
    showBrand: false,
    showStock: false,
    stockLabel: "",
    stockHint: "",
    stockPlaceholder: "",
    descriptionSectionDescription:
      "Опишите направления, сроки, условия доставки и способы связи через заявку.",
    descriptionPlaceholder:
      "Опишите направления, сроки, условия доставки и способы связи через заявку.",
    descriptionTips: [
      ...
      "Как связаться через заявку",
    ],
    sidebarTips: [
      "Укажите направления явно",
      "Опишите сроки и условия",
      "Добавьте фото склада или транспорта",
      "Назовите город / офис",
    ],
    previewQuantityLabel: "",
  },
