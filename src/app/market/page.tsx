...
const MARKET_FALLBACK_CATEGORIES: VerticalCategoryCard[] = [
  ...
  { id: "fallback-auto", name: "Авто", slug: "market-avto-i-moto", vertical: "MARKET" },
  ...
  { id: "fallback-equipment", name: "Оборудование", slug: "market-bytovaya-tehnika", vertical: "MARKET" },
