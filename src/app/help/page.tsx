...
const faqItems = [
  {
    ...
    answer:
      "ВсеТут — платформа объявлений, услуг, оптовых предложений и карго в Кыргызстане. Продавцы публикуют предложения, покупатели находят нужное и связываются напрямую.",
  },
  {
    question: "Можно ли купить товар на сайте?",
    answer:
      "Нет. ВсеТут не является интернет-магазином. Вы отправляете заявку или связываетесь с продавцом, а условия сделки обсуждаются напрямую.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "После входа в аккаунт вы увидите контакты продавца и сможете отправить заявку.",
  },
];
