    ...
    <main className="bg-white py-10 sm:py-14">
      <Container>
        <PublicPageHeader
          ...
          description="Как Tutopt собирает, использует и защищает персональные данные пользователей."
        />

        <div className="mt-10 max-w-3xl space-y-6 text-sm leading-relaxed text-slate-600 sm:text-base">
          <p>
            Настоящая политика описывает порядок обработки персональных данных на платформе Tutopt.
