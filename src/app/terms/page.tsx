    ...
    <main className="bg-white py-10 sm:py-14">
      <Container>
        ...
        <div className="mt-10 max-w-3xl space-y-6 text-sm leading-relaxed text-slate-600 sm:text-base">
          <p>
            Используя ВсеТут, вы соглашаетесь с правилами платформы. Полный юридический текст будет
            опубликован перед публичным запуском.
          </p>
          <section>
            <h2 className="text-lg font-semibold text-slate-900">Роль платформы</h2>
            <p className="mt-3">
              ВсеТут предоставляет площадку для размещения объявлений и не является стороной
