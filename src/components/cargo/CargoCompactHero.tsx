...
export function CargoCompactHero({ categories }: CargoCompactHeroProps) {
  ...
  return (
    <section className="relative min-h-[300px] overflow-hidden border-b border-rose-200/40 shadow-sm md:h-[300px]">
      <div
        aria-hidden="true"
        ...
        <Container size="lg" className="min-w-0 px-0 sm:px-6 lg:px-8">
          <div className="flex w-full max-w-5xl min-w-0 flex-col gap-3 md:flex-row md:items-center md:gap-4">
            <h1 className="shrink-0 text-lg font-medium leading-tight text-white drop-shadow-sm md:text-xl">
              Ищите <span className="font-bold text-white">карго</span>
            </h1>

            <SearchWithSuggest
              variant="phrase"
              placeholder="Найти доставку, карго или перевозчика..."
              buttonLabel="Найти"
            ...
            <Drawer open={open} onOpenChange={setOpen}>
              ...
              >
                <DrawerHeader className="border-b border-slate-100 pr-12">
                  ...
                  <DrawerDescription>
                    Выберите раздел карго
                  </DrawerDescription>
                </DrawerHeader>

                <nav
                  aria-label="Категории карго"
