...
export function ServicesCompactHero({ categories }: ServicesCompactHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-teal-200/40 shadow-sm">
      <div
        aria-hidden="true"
                        ...
                        return (
                          <li key={category.id}>
                            <DrawerClose asChild>
                              <Link
                                href={href}
                                className="flex min-h-12 items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-800 transition hover:bg-teal-50"
                              >
                                <span
                                  className={cn(
