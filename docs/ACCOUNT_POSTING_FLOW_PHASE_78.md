...
- Unified account dashboard: **done in Phase 81** (`/account`) — see `docs/UNIFIED_ACCOUNT_DASHBOARD_PHASE_81.md`
...
- Phase 86: `docs/VERTICAL_THEME_PHASE_86.md` — type chooser / submit colors follow vertical
