...
## Final smoke / launch blockers — Phase 49

Выполнено в Phase 49 (см. `docs/FINAL_SMOKE_TEST_CHECKLIST.md`, `docs/LAUNCH_BLOCKERS.md`):

- Финальный manual smoke checklist (public/auth/seller/buyer/admin/prod/mobile).
